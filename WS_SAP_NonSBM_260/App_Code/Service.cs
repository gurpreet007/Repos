...
public class Service_WS_SAP_NonSBM_260 : IService
{
    ...
    public SAP_Cols_Ret[] GetDataUsingDataContract(SAP_Cols[] arr_scols)
    {
        ...
        string sqlIns = @"INSERT INTO ONLINEBILL.SAP_NONSBM(
                    ...
                    nres1, nres2, nres3, nres4, nres5,
                    nres6, nres7, nres8, nres9, nres10, 
                    nres11, nres12, vres1, vres2, dated
                    ) VALUES (
                    ...
                    '{251}', '{252}', '{253}', '{254}', '{255}', '{256}', '{257}', '{258}', sysdate
                    ) ";
        ...
        using (eventLog1 = new EventLog("ePay_NonSBM", ".", "SAP_NonSBM_260"))
        {
            if (arr_scols == null)
            {
            ...
            foreach (SAP_Cols scols in arr_scols)
            {
                ...
                sql = string.Format(sqlIns,
                        ...
                        scols.Nres1,scols.Nres2,scols.Nres3,scols.Nres4,scols.Nres5,
                        scols.Nres6,scols.Nres7,scols.Nres8,scols.Nres9,scols.Nres10,
                        scols.Nres11,scols.Nres12,scols.Vres1,scols.Vres2
                    );
