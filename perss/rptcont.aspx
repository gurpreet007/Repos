<%@ Page Title="" Language="VB" MasterPageFile="~/Site1.master" AutoEventWireup="false" CodeFile="rptcont.aspx.vb" Inherits="rptcont" %>
   ...
   <div align = "center">
        ...
        <tr>
            <td colspan="2" align ="center">
                <asp:Label ID="Label3" runat="server" 
                    ...
                    Text="Organisation Wise List of Posts"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2" align ="center">
        ...
        <tr>
            ...
            <td style="text-align: left" class="style1">
                <asp:Button ID="btnPreGenerate" runat="server" 
                    Text="Pre-Generate Detailed Report" Width="215px" height="26px" />
            &nbsp;&nbsp;
        ...
        <tr>
            ...
            <td style="text-align: left" class="style1">
                <asp:Button ID="btnPreGenerateAll" runat="server" 
                    Text="Pre-Generate All Detailed Reports" Width="215px" Height="26px" />
            &nbsp;&nbsp;
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td style="text-align: left" class="style1">
                <asp:Button ID="btnMatrix" runat="server" Text="Export Desg Matrix" />
            &nbsp;&nbsp;
                <asp:Label ID="Label7" runat="server" Font-Bold="False" ForeColor="Red" 
                    Text="(Will Take About 2 min)"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
