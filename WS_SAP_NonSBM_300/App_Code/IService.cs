...
public class SAP_Cols
{
    ...
    public string Pre_Met_Red_Kwhex { get; set; }
    public string Pre_Met_Red_Kvhex { get; set; }
    public string Pre_Met_Red_Kvaex { get; set; }
    public string Pre_Met_Red_Kwhnet { get; set; }
    public string Pre_Met_Red_Kvhnet { get; set; }
    public string Pre_Met_Red_Kvanet { get; set; }
    public string Curr_Met_Red_Kwhex { get; set; }
    public string Curr_Met_Red_Kvhex { get; set; }
    public string Curr_Met_Red_Kvaex { get; set; }
    public string Curr_Met_Red_Kwhnet { get; set; }
    public string Curr_Met_Red_Kvhnet { get; set; }
    public string Curr_Met_Red_Kvanet { get; set; }
    public string Add_Sup_Unit_Kwhex { get; set; }
    public string Add_Sup_Unit_Kvhex { get; set; }
    public string Add_Sup_Unit_Kvaex { get; set; }
    public string Add_Sup_Unit_Kwhnet { get; set; }
    public string Add_Sup_Unit_Kvhnet { get; set; }
    public string Add_Sup_Unit_Kvanet { get; set; }
    public string Cur_Cons_Kwhex { get; set; }
    public string Cur_Cons_Kvhex { get; set; }
    public string Cur_Cons_Kvaex { get; set; }
    public string Cur_Cons_Kwhnet { get; set; }
    public string Cur_Cons_Kvhnet { get; set; }
    public string Cur_Cons_Kvanet { get; set; }
    public string Pre_Met_Red_Kwhs { get; set; }
    public string Pre_Met_Red_Kvahs { get; set; }
    public string Pre_Met_Red_Kvas { get; set; }
    public string Curr_Met_Red_Kwhs { get; set; }
    public string Curr_Met_Red_Kvahs { get; set; }
    public string Curr_Met_Red_Kvas { get; set; }
    public string Add_Sup_Unit_Kwhs { get; set; }
    public string Add_Sup_Unit_Kvahs { get; set; }
    public string Add_Sup_Unit_Kvas { get; set; }
    public string Cur_Cons_Kwhs { get; set; }
    public string Cur_Cons_Kvahs { get; set; }
    public string Cur_Cons_Kvas { get; set; }
    public string Pre_Carry { get; set; }
    public string Curr_Carry { get; set; }
    public string Tot_Cons { get; set; }
    ...
    public string Nres13 { get; set; }
    public string Nres14 { get; set; }
    ...
    public override string ToString()
    {
        string str = "Tariff_Type = " + Tariff_Type + "\r\n " +
                        ...
                        "Pre_Met_Red_Kwhex = " + Pre_Met_Red_Kwhex + "\r\n " +
                        "Pre_Met_Red_Kvhex = " + Pre_Met_Red_Kvhex + "\r\n " +
                        "Pre_Met_Red_Kvaex = " + Pre_Met_Red_Kvaex + "\r\n " +
                        "Pre_Met_Red_Kwhnet = " + Pre_Met_Red_Kwhnet + "\r\n " +
                        "Pre_Met_Red_Kvhnet = " + Pre_Met_Red_Kvhnet + "\r\n " +
                        "Pre_Met_Red_Kvanet = " + Pre_Met_Red_Kvanet + "\r\n " +
                        "Curr_Met_Red_Kwhex = " + Curr_Met_Red_Kwhex + "\r\n " +
                        "Curr_Met_Red_Kvhex = " + Curr_Met_Red_Kvhex + "\r\n " +
                        "Curr_Met_Red_Kvaex = " + Curr_Met_Red_Kvaex + "\r\n " +
                        "Curr_Met_Red_Kwhnet = " + Curr_Met_Red_Kwhnet + "\r\n " +
                        "Curr_Met_Red_Kvhnet = " + Curr_Met_Red_Kvhnet + "\r\n " +
                        "Curr_Met_Red_Kvanet = " + Curr_Met_Red_Kvanet + "\r\n " +
                        "Add_Sup_Unit_Kwhex = " + Add_Sup_Unit_Kwhex + "\r\n " +
                        "Add_Sup_Unit_Kvhex = " + Add_Sup_Unit_Kvhex + "\r\n " +
                        "Add_Sup_Unit_Kvaex = " + Add_Sup_Unit_Kvaex + "\r\n " +
                        "Add_Sup_Unit_Kwhnet = " + Add_Sup_Unit_Kwhnet + "\r\n " +
                        "Add_Sup_Unit_Kvhnet = " + Add_Sup_Unit_Kvhnet + "\r\n " +
                        "Add_Sup_Unit_Kvanet = " + Add_Sup_Unit_Kvanet + "\r\n " +
                        "Cur_Cons_Kwhex = " + Cur_Cons_Kwhex + "\r\n " +
                        "Cur_Cons_Kvhex = " + Cur_Cons_Kvhex + "\r\n " +
                        "Cur_Cons_Kvaex = " + Cur_Cons_Kvaex + "\r\n " +
                        "Cur_Cons_Kwhnet = " + Cur_Cons_Kwhnet + "\r\n " +
                        "Cur_Cons_Kvhnet = " + Cur_Cons_Kvhnet + "\r\n " +
                        "Cur_Cons_Kvanet = " + Cur_Cons_Kvanet + "\r\n " +
                        "Pre_Met_Red_Kwhs = " + Pre_Met_Red_Kwhs + "\r\n " +
                        "Pre_Met_Red_Kvahs = " + Pre_Met_Red_Kvahs + "\r\n " +
                        "Pre_Met_Red_Kvas = " + Pre_Met_Red_Kvas + "\r\n " +
                        "Curr_Met_Red_Kwhs = " + Curr_Met_Red_Kwhs + "\r\n " +
                        "Curr_Met_Red_Kvahs = " + Curr_Met_Red_Kvahs + "\r\n " +
                        "Curr_Met_Red_Kvas = " + Curr_Met_Red_Kvas + "\r\n " +
                        "Add_Sup_Unit_Kwhs = " + Add_Sup_Unit_Kwhs + "\r\n " +
                        "Add_Sup_Unit_Kvahs = " + Add_Sup_Unit_Kvahs + "\r\n " +
                        "Add_Sup_Unit_Kvas = " + Add_Sup_Unit_Kvas + "\r\n " +
                        "Cur_Cons_Kwhs = " + Cur_Cons_Kwhs + "\r\n " +
                        "Cur_Cons_Kvahs = " + Cur_Cons_Kvahs + "\r\n " +
                        "Cur_Cons_Kvas = " + Cur_Cons_Kvas + "\r\n " +
                        "Pre_Carry = " + Pre_Carry + "\r\n " +
                        "Curr_Carry = " + Curr_Carry + "\r\n " +
                        "Tot_Cons = " + Tot_Cons + "\r\n " +
                        "Nres1 = " + Nres1 + "\r\n " +
                        "Nres2 = " + Nres2 + "\r\n " +
                        "Nres3 = " + Nres3 + "\r\n " +
